 ...
 * @param [root='crate'] optional import root
 * @returns the fully qualified import path
 */
export function buildImportPath(dst: rust.ModuleContainer, src: rust.ModuleContainer, root: string = 'crate'): string {
