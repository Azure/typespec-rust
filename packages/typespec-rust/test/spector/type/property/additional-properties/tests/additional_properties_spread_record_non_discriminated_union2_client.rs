...
use spector_addlprops::{
    models::{
        ...
        SpreadRecordForNonDiscriminatedUnion2AdditionalProperty, WidgetData1, WidgetData2,
    },
...
fn body() -> SpreadRecordForNonDiscriminatedUnion2 {
...
async fn get() {
    ...
    let resp = client
        .get_additional_properties_spread_record_non_discriminated_union2_client()
        .get(None)
        .await
        .unwrap()
        .into_model()
