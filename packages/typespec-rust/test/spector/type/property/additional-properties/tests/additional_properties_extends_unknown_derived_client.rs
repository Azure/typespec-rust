...
use spector_addlprops::{
    models::ExtendsUnknownAdditionalPropertiesDerived, AdditionalPropertiesClient,
};
use std::collections::HashMap;

fn body() -> ExtendsUnknownAdditionalPropertiesDerived {
...
async fn get() {
    ...
    let resp = client
        .get_additional_properties_extends_unknown_derived_client()
        .get(None)
        .await
        .unwrap()
        .into_model()
