...
use spector_addlprops::{models::IsFloatAdditionalProperties, AdditionalPropertiesClient};
use std::collections::HashMap;

fn body() -> IsFloatAdditionalProperties {
...
async fn get() {
    ...
    let resp = client
        .get_additional_properties_is_float_client()
        .get(None)
        .await
        .unwrap()
        .into_model()
