...
use crate::generated::models::{
    EnumProperty, ValueTypesEnumClientGetOptions, ValueTypesEnumClientPutOptions,
};
use azure_core::{
...
#[tracing::client]
pub struct ValueTypesEnumClient {
    pub(crate) endpoint: Url,
    pub(crate) pipeline: Pipeline,
}

impl ValueTypesEnumClient {
    ...
    ) -> Result<Response<EnumProperty>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        url.append_path("/type/property/value-types/enum");
    ...
    pub async fn put(
        ...
        options: Option<ValueTypesEnumClientPutOptions<'_>>,
