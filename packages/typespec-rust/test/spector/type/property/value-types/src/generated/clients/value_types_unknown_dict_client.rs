...
use crate::generated::models::{
    UnknownDictProperty, ValueTypesUnknownDictClientGetOptions,
    ValueTypesUnknownDictClientPutOptions,
};
use azure_core::{
...
impl ValueTypesUnknownDictClient {
    ...
    ) -> Result<Response<UnknownDictProperty>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        url.append_path("type/property/value-types/unknown/dict");
    ...
    pub async fn put(
        ...
        options: Option<ValueTypesUnknownDictClientPutOptions<'_>>,
