...
use crate::generated::models::{
    UnionEnumValueProperty, ValueTypesUnionEnumValueClientGetOptions,
...
impl ValueTypesUnionEnumValueClient {
    ...
    ) -> Result<Response<UnionEnumValueProperty>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        url.append_path("type/property/value-types/union-enum-value");
