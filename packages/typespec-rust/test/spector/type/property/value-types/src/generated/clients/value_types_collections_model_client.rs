...
use crate::generated::models::{
    CollectionsModelProperty, ValueTypesCollectionsModelClientGetOptions,
    ValueTypesCollectionsModelClientPutOptions,
};
use azure_core::{
...
#[tracing::client]
pub struct ValueTypesCollectionsModelClient {
    pub(crate) endpoint: Url,
    pub(crate) pipeline: Pipeline,
}

impl ValueTypesCollectionsModelClient {
    ...
    pub async fn get(
        ...
        url.append_path("type/property/value-types/collections/model");
    ...
    pub async fn put(
        ...
        options: Option<ValueTypesCollectionsModelClientPutOptions<'_>>,
