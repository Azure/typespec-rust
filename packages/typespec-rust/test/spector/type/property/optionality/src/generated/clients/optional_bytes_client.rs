...
use crate::generated::models::{
    BytesProperty, OptionalBytesClientGetAllOptions, OptionalBytesClientGetDefaultOptions,
    OptionalBytesClientPutAllOptions, OptionalBytesClientPutDefaultOptions,
};
use azure_core::{
...
#[tracing::client]
pub struct OptionalBytesClient {
    pub(crate) endpoint: Url,
    pub(crate) pipeline: Pipeline,
}

impl OptionalBytesClient {
    ...
    pub async fn get_all(
        ...
        url.append_path("type/property/optional/bytes/all");
    ...
    pub async fn get_default(
        ...
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        url.append_path("type/property/optional/bytes/default");
        let mut request = Request::new(url, Method::Get);
        request.insert_header("accept", "application/json");
        let rsp = self
            .pipeline
    ...
    pub async fn put_all(
        ...
        options: Option<OptionalBytesClientPutAllOptions<'_>>,
    ...
    pub async fn put_default(
        &self,
        body: RequestContent<BytesProperty>,
        options: Option<OptionalBytesClientPutDefaultOptions<'_>>,
    ) -> Result<Response<(), NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
