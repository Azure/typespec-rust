...
use crate::generated::models::{
    DurationProperty, OptionalDurationClientGetAllOptions, OptionalDurationClientGetDefaultOptions,
    OptionalDurationClientPutAllOptions, OptionalDurationClientPutDefaultOptions,
};
use azure_core::{
...
impl OptionalDurationClient {
    ...
    pub async fn get_all(
        ...
        url.append_path("/type/property/optional/duration/all");
    ...
    pub async fn get_default(
        ...
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        url.append_path("/type/property/optional/duration/default");
        let mut request = Request::new(url, Method::Get);
        request.insert_header("accept", "application/json");
        let rsp = self
            .pipeline
    ...
    pub async fn put_all(
        ...
        options: Option<OptionalDurationClientPutAllOptions<'_>>,
    ...
    pub async fn put_default(
        &self,
        body: RequestContent<DurationProperty>,
        options: Option<OptionalDurationClientPutDefaultOptions<'_>>,
    ) -> Result<Response<(), NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
