...
async fn default() {
    ...
    let resp = client
        ...
        .await
        .unwrap();
    let value: DefaultDatetimeProperty = resp.into_model().unwrap();
...
async fn rfc3339() {
    ...
    let resp = client
        ...
        .await
        .unwrap();
    let value: Rfc3339DatetimeProperty = resp.into_model().unwrap();
    assert_eq!(value.value, Some(odt_utc));
}
...
async fn rfc7231() {
    ...
    let resp = client
        ...
        .await
        .unwrap();
    let value: Rfc7231DatetimeProperty = resp.into_model().unwrap();
    assert_eq!(value.value, Some(odt_utc));
}
...
async fn unix_timestamp() {
    ...
    let resp = client
        ...
        .await
        .unwrap();
    let value: UnixTimestampDatetimeProperty = resp.into_model().unwrap();
    assert_eq!(value.value, Some(odt_utc));
}
...
async fn unix_timestamp_array() {
    ...
    let resp = client
        ...
        .await
        .unwrap();
    let value: UnixTimestampArrayDatetimeProperty = resp.into_model().unwrap();
