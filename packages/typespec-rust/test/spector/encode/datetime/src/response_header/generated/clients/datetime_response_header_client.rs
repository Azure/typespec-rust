...
use crate::response_header::generated::models::{
...
impl DatetimeResponseHeaderClient {
    ...
    /// use spector_datetime::response_header::models::{DatetimeResponseHeaderClientDefaultResult, DatetimeResponseHeaderClientDefaultResultHeaders};
    ...
    /// ```no_run
    /// use azure_core::{Result, http::{Response, NoFormat}};
    /// use spector_datetime::response_header::models::{DatetimeResponseHeaderClientRfc3339Result, DatetimeResponseHeaderClientRfc3339ResultHeaders};
    /// async fn example() -> Result<()> {
    ...
    /// ```no_run
    /// use azure_core::{Result, http::{Response, NoFormat}};
    /// use spector_datetime::response_header::models::{DatetimeResponseHeaderClientUnixTimestampResult, DatetimeResponseHeaderClientUnixTimestampResultHeaders};
    /// async fn example() -> Result<()> {
