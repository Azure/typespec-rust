...
use crate::generated::models::{
    GenerationOptions, OperationState, RpcClientBeginLongRunningRpcOperationStatus,
...
impl RpcClient {
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`RpcClientBeginLongRunningRpcOperationStatusHeaders`] trait, which provides
    ...
    ///
    /// ### Available headers
    /// * [`operation_location`()](crate::generated::models::RpcClientBeginLongRunningRpcOperationStatusHeaders::operation_location) - operation-location
    ///
    /// [`RpcClientBeginLongRunningRpcOperationStatusHeaders`]: crate::generated::models::RpcClientBeginLongRunningRpcOperationStatusHeaders
    #[tracing::function("_Specs_.Azure.Core.Lro.Rpc.longRunningRpc")]
    pub fn begin_long_running_rpc(
        &self,
        body: RequestContent<GenerationOptions>,
        options: Option<RpcClientBeginLongRunningRpcOptions<'_>>,
    ) -> Result<Poller<RpcClientBeginLongRunningRpcOperationStatus>> {
        ...
        struct RpcClientBeginLongRunningRpcMonitor {
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: RpcClientBeginLongRunningRpcMonitor = json::from_json(&body)?;
