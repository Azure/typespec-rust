...
use crate::generated::models::{
    OperationState, StandardClientBeginCreateOrReplaceOperationStatus,
    StandardClientBeginCreateOrReplaceOptions, StandardClientBeginDeleteOperationStatus,
    StandardClientBeginDeleteOptions, StandardClientBeginExportOperationStatus,
...
impl StandardClient {
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`StandardClientBeginCreateOrReplaceOperationStatusHeaders`] trait, which provides
    ...
    ///
    /// ### Available headers
    /// * [`operation_location`()](crate::generated::models::StandardClientBeginCreateOrReplaceOperationStatusHeaders::operation_location) - operation-location
    ///
    /// [`StandardClientBeginCreateOrReplaceOperationStatusHeaders`]: crate::generated::models::StandardClientBeginCreateOrReplaceOperationStatusHeaders
    ...
    pub fn begin_create_or_replace(
        ...
        options: Option<StandardClientBeginCreateOrReplaceOptions<'_>>,
    ) -> Result<Poller<StandardClientBeginCreateOrReplaceOperationStatus>> {
        ...
        struct StandardClientBeginCreateOrReplaceMonitor {
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: StandardClientBeginCreateOrReplaceMonitor = json::from_json(&body)?;
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`StandardClientBeginDeleteOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    ...
    ///
    /// ### Available headers
    /// * [`operation_location`()](crate::generated::models::StandardClientBeginDeleteOperationStatusHeaders::operation_location) - operation-location
    ///
    /// [`StandardClientBeginDeleteOperationStatusHeaders`]: crate::generated::models::StandardClientBeginDeleteOperationStatusHeaders
    #[tracing::function("_Specs_.Azure.Core.Lro.Standard.delete")]
    pub fn begin_delete(
        &self,
        name: &str,
        options: Option<StandardClientBeginDeleteOptions<'_>>,
    ) -> Result<Poller<StandardClientBeginDeleteOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("/azure/core/lro/standard/users/{name}");
        ...
        let api_version = self.api_version.clone();
        #[derive(serde::Deserialize)]
        struct StandardClientBeginDeleteMonitor {
            status: Option<OperationState>,
        }
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: StandardClientBeginDeleteMonitor = json::from_json(&body)?;
                    let poller_status: PollerStatus = match &res.status {
                        Some(v) => PollerStatus::from(v.as_ref()),
                        None => PollerStatus::InProgress,
                    };
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`StandardClientBeginExportOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    ...
    ///
    /// ### Available headers
    /// * [`operation_location`()](crate::generated::models::StandardClientBeginExportOperationStatusHeaders::operation_location) - operation-location
    ///
    /// [`StandardClientBeginExportOperationStatusHeaders`]: crate::generated::models::StandardClientBeginExportOperationStatusHeaders
    #[tracing::function("_Specs_.Azure.Core.Lro.Standard.export")]
    pub fn begin_export(
        &self,
        name: &str,
        format: &str,
        options: Option<StandardClientBeginExportOptions<'_>>,
    ) -> Result<Poller<StandardClientBeginExportOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        ...
        let api_version = self.api_version.clone();
        #[derive(serde::Deserialize)]
        struct StandardClientBeginExportMonitor {
            status: Option<OperationState>,
        }
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: StandardClientBeginExportMonitor = json::from_json(&body)?;
                    let poller_status: PollerStatus = match &res.status {
                        Some(v) => PollerStatus::from(v.as_ref()),
                        None => PollerStatus::InProgress,
                    };
