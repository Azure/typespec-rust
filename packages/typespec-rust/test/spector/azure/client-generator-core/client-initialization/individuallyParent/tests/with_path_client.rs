...
use spector_clientinit_individually_parent::{
    models::{
        BlobProperties, IndividuallyParentIndividuallyParentNestedWithPathClientWithQueryOptions,
    },
...
async fn delete_standalone() {
    ...
    client
        .get_individually_parent_individually_parent_nested_with_path_client(
            "test-blob".to_string(),
        )
