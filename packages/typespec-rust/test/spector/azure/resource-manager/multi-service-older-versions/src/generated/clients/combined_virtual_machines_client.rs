...
impl CombinedVirtualMachinesClient {
    ...
    /// use spector_arm_multi_service_older_versions::models::{CombinedVirtualMachinesClientCreateOrUpdateOperationStatus, CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders};
