...
use crate::compute::generated::models::{
    ...
    CombinedVirtualMachinesClientCreateOrUpdateOptions, CombinedVirtualMachinesClientGetOptions,
    VirtualMachine,
};
use azure_core::{
...
impl CombinedVirtualMachinesClient {
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    /// use spector_arm_multi_service_older_versions::compute::models::{CombinedVirtualMachinesClientCreateOrUpdateOperationStatus, CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders};
    ...
    ///
    /// ### Available headers
    /// * [`azure_async_operation`()](crate::generated::models::CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders::azure_async_operation) - azure-asyncoperation
    /// * [`retry_after`()](crate::generated::models::CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders`]: crate::generated::models::CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders
    #[tracing::function(
        "Azure.ResourceManager.MultiServiceOlderVersions.Compute.VirtualMachines.createOrUpdate"
    )]
    pub fn create_or_update(
        ...
        options: Option<CombinedVirtualMachinesClientCreateOrUpdateOptions<'_>>,
    ) -> Result<Poller<CombinedVirtualMachinesClientCreateOrUpdateOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachinesOld/{vmName}");
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: CombinedVirtualMachinesClientCreateOrUpdateOperationStatus =
                        json::from_json(&body)?;
    ...
    /// * `options` - Optional parameters for the request.
    #[tracing::function(
        "Azure.ResourceManager.MultiServiceOlderVersions.Compute.VirtualMachines.get"
    )]
    pub async fn get(
        &self,
        resource_group_name: &str,
