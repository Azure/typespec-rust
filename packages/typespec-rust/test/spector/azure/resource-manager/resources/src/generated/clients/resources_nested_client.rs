...
use crate::generated::models::{
    NestedProxyResource, NestedProxyResourceListResult, ResourceProvisioningState,
...
impl ResourcesNestedClient {
    ...
    pub fn begin_create_or_replace(
        ...
        struct ResourcesNestedClientBeginCreateOrReplaceMonitor {
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: ResourcesNestedClientBeginCreateOrReplaceMonitor =
                        json::from_json(&body)?;
    ...
    pub fn begin_delete(
        ...
        let api_version = self.api_version.clone();
        #[derive(serde::Deserialize)]
        struct ResourcesNestedClientBeginDeleteMonitor {
            status: Option<ResourceProvisioningState>,
        }
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: ResourcesNestedClientBeginDeleteMonitor = json::from_json(&body)?;
                    let poller_status: PollerStatus = match &res.status {
                        Some(v) => PollerStatus::from(v.as_ref()),
                        None => PollerStatus::InProgress,
                    };
    ...
    pub fn begin_update(
        ...
        let api_version = self.api_version.clone();
        #[derive(serde::Deserialize)]
        struct ResourcesNestedClientBeginUpdateMonitor {
            status: Option<ResourceProvisioningState>,
        }
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: ResourcesNestedClientBeginUpdateMonitor = json::from_json(&body)?;
                    let poller_status: PollerStatus = match &res.status {
                        Some(v) => PollerStatus::from(v.as_ref()),
                        None => PollerStatus::InProgress,
                    };
    ...
    pub fn list_by_top_level_tracked_resource(
        ...
        query_builder.build();
        #[derive(serde::Deserialize)]
        struct ResourcesNestedClientListByTopLevelTrackedResourcePage {
            ...
            move |next_link: PagerState, pager_options| {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        let res: ResourcesNestedClientListByTopLevelTrackedResourcePage =
                            json::from_json(&body)?;
                        let rsp = RawResponse::from_bytes(status, headers, body).into();
