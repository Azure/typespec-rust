...
use crate::generated::models::{
    ExtensionsResource, ExtensionsResourceListResult, ResourceProvisioningState,
...
impl ResourcesExtensionsResourcesClient {
    ...
    pub fn begin_create_or_update(
        ...
        struct ResourcesExtensionsResourcesClientBeginCreateOrUpdateMonitor {
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: ResourcesExtensionsResourcesClientBeginCreateOrUpdateMonitor =
                        json::from_json(&body)?;
