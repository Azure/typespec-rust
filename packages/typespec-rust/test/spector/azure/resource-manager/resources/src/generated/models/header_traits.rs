...
use azure_core::{Result, http::{Response, headers::{HeaderName, Headers, }, }, };
use super::{ArmOperationStatusResourceProvisioningState, ExtensionsResource, NestedProxyResource, SingletonTrackedResource, TopLevelTrackedResource, };
...
impl ArmOperationStatusResourceProvisioningStateHeaders for Response<ArmOperationStatusResourceProvisioningState> {
