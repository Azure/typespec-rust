...
use crate::generated::models::{
    ...
    ResourcesSingletonClientUpdateOptions, SingletonTrackedResource,
...
impl ResourcesSingletonClient {
    ...
    pub fn resume_singleton_tracked_resource_operation(
        &self,
        resource_group_name: &str,
        options: Option<ResourcesSingletonClientResumeSingletonTrackedResourceOperationOptions<'_>>,
    ) -> Result<Poller<SingletonTrackedResource>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
