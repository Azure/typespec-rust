...
use crate::generated::models::{ResourcesSingletonClientBeginCreateOrUpdateOptions, ResourcesSingletonClientGetByResourceGroupOptions, ResourcesSingletonClientListByResourceGroupOptions, ResourcesSingletonClientResumeSingletonTrackedResourceOperationOptions, ResourcesSingletonClientUpdateOptions, SingletonTrackedResource, SingletonTrackedResourceListResult, };
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn begin_create_or_update(&self, resource_group_name: &str, resource: RequestContent<SingletonTrackedResource>, options: Option<ResourcesSingletonClientBeginCreateOrUpdateOptions<'_>>) -> Result<Poller<SingletonTrackedResource>> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get_by_resource_group(&self, resource_group_name: &str, options: Option<ResourcesSingletonClientGetByResourceGroupOptions<'_>>) -> Result<Response<SingletonTrackedResource>> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_by_resource_group(&self, resource_group_name: &str, options: Option<ResourcesSingletonClientListByResourceGroupOptions<'_>>) -> Result<Pager<SingletonTrackedResourceListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
...
/// * `resource_group_name` - The name of the resource group. The name is case insensitive.
/// * `options` - Optional parameters for the request.
    #[tracing::function("ResourcesSingleton.SingletonTrackedResource.resume")]
    pub fn resume_singleton_tracked_resource_operation(&self, resource_group_name: &str, options: Option<ResourcesSingletonClientResumeSingletonTrackedResourceOperationOptions<'_>>) -> Result<Poller<SingletonTrackedResource>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/singletonTrackedResources/default");
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn update(&self, resource_group_name: &str, properties: RequestContent<SingletonTrackedResource>, options: Option<ResourcesSingletonClientUpdateOptions<'_>>) -> Result<Response<SingletonTrackedResource>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/singletonTrackedResources/default");
