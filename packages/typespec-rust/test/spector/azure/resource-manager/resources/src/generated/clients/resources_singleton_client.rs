...
use crate::generated::models::{
    ResourceProvisioningState, ResourcesSingletonClientBeginCreateOrUpdateOperationStatus,
...
impl ResourcesSingletonClient {
    ...
    pub fn begin_create_or_update(
        ...
        struct ResourcesSingletonClientBeginCreateOrUpdateMonitor {
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: ResourcesSingletonClientBeginCreateOrUpdateMonitor =
                        json::from_json(&body)?;
    ...
    pub fn list_by_resource_group(
        ...
        query_builder.build();
        #[derive(serde::Deserialize)]
        struct ResourcesSingletonClientListByResourceGroupPage {
            ...
            move |next_link: PagerState, pager_options| {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        let res: ResourcesSingletonClientListByResourceGroupPage =
                            json::from_json(&body)?;
                        let rsp = RawResponse::from_bytes(status, headers, body).into();
