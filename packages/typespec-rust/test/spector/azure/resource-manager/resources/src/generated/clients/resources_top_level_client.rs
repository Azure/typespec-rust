...
use crate::generated::models::{
    CreateOrReplaceOperationStatus, DeleteOperationStatus, NotificationDetails,
    ...
    TopLevelTrackedResource, TopLevelTrackedResourceListResult, UpdateOperationStatus,
};
use azure_core::{
...
impl ResourcesTopLevelClient {
    ...
    /// use spector_armresources::models::{CreateOrReplaceOperationStatus, CreateOrReplaceOperationStatusHeaders};
    ...
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    /// use spector_armresources::models::{DeleteOperationStatus, DeleteOperationStatusHeaders};
    /// async fn example() -> Result<()> {
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`UpdateOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    /// use spector_armresources::models::{UpdateOperationStatus, UpdateOperationStatusHeaders};
    /// async fn example() -> Result<()> {
    ///     let response: Response<UpdateOperationStatus> = unimplemented!();
    ///     // Access response headers
    ///     if let Some(location) = response.location()? {
    ///         println!("Location: {:?}", location);
    ///     }
    ...
    ///
    /// ### Available headers
    /// * [`location`()](crate::generated::models::UpdateOperationStatusHeaders::location) - Location
    /// * [`retry_after`()](crate::generated::models::UpdateOperationStatusHeaders::retry_after) - Retry-After
    ///
    /// [`UpdateOperationStatusHeaders`]: crate::generated::models::UpdateOperationStatusHeaders
    ...
    ) -> Result<Poller<UpdateOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}");
        ...
        Ok(Poller::from_callback(
            move |next_link: PollerState<Url>| {
                ...
                async move {
                    ...
                    let res: UpdateOperationStatus = json::from_json(&body)?;
                    let rsp = RawResponse::from_bytes(status, headers, body).into();
                    Ok(match res.status() {
                        PollerStatus::InProgress => PollerResult::InProgress {
                            response: rsp,
