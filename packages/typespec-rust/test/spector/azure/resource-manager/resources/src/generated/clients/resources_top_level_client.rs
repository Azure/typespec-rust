...
use azure_core::{Error, Result, error::{ErrorKind, HttpError, }, http::{Context, Method, NoFormat, Pager, PagerResult, PagerState, Pipeline, Poller, PollerStatus, RawResponse, Request, RequestContent, Response, Url, poller::{PollerResult, PollerState, StatusMonitor as _, get_retry_after, }, }, json, tracing, };
use crate::generated::models::{ArmOperationStatusResourceProvisioningState, NotificationDetails, ResourcesTopLevelClientActionSyncOptions, ResourcesTopLevelClientBeginCreateOrReplaceOptions, ResourcesTopLevelClientBeginDeleteOptions, ResourcesTopLevelClientBeginUpdateOptions, ResourcesTopLevelClientGetOptions, ResourcesTopLevelClientListByResourceGroupOptions, ResourcesTopLevelClientListBySubscriptionOptions, ResourcesTopLevelClientResumeArmOperationStatusResourceProvisioningStateOperationOptions, ResourcesTopLevelClientResumeTopLevelTrackedResourceOperationOptions, TopLevelTrackedResource, TopLevelTrackedResourceListResult, };
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn action_sync(&self, resource_group_name: &str, top_level_tracked_resource_name: &str, body: RequestContent<NotificationDetails>, options: Option<ResourcesTopLevelClientActionSyncOptions<'_>>) -> Result<Response<(), NoFormat>> {
        ...
        path = path.replace("{topLevelTrackedResourceName}", top_level_tracked_resource_name);
        url = url.join(&path)?;
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn begin_create_or_replace(&self, resource_group_name: &str, top_level_tracked_resource_name: &str, resource: RequestContent<TopLevelTrackedResource>, options: Option<ResourcesTopLevelClientBeginCreateOrReplaceOptions<'_>>) -> Result<Poller<TopLevelTrackedResource>> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn begin_delete(&self, resource_group_name: &str, top_level_tracked_resource_name: &str, options: Option<ResourcesTopLevelClientBeginDeleteOptions<'_>>) -> Result<Poller<ArmOperationStatusResourceProvisioningState>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}");
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn begin_update(&self, resource_group_name: &str, top_level_tracked_resource_name: &str, properties: RequestContent<TopLevelTrackedResource>, options: Option<ResourcesTopLevelClientBeginUpdateOptions<'_>>) -> Result<Poller<TopLevelTrackedResource>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}");
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get(&self, resource_group_name: &str, top_level_tracked_resource_name: &str, options: Option<ResourcesTopLevelClientGetOptions<'_>>) -> Result<Response<TopLevelTrackedResource>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}");
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_by_resource_group(&self, resource_group_name: &str, options: Option<ResourcesTopLevelClientListByResourceGroupOptions<'_>>) -> Result<Pager<TopLevelTrackedResourceListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
...
if !rsp.status().is_success() {
                ...
                Ok(match res.next_link {
                    Some(next_link) if !next_link.is_empty() => PagerResult::More {
                        response: rsp, continuation: next_link.parse()?                    },
                    _ => PagerResult::Done {
                        response: rsp                    },
                })
            }
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_by_subscription(&self, options: Option<ResourcesTopLevelClientListBySubscriptionOptions<'_>>) -> Result<Pager<TopLevelTrackedResourceListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn resume_arm_operation_status_resource_provisioning_state_operation(&self, resource_group_name: &str, top_level_tracked_resource_name: &str, options: Option<ResourcesTopLevelClientResumeArmOperationStatusResourceProvisioningStateOperationOptions<'_>>) -> Result<Poller<ArmOperationStatusResourceProvisioningState>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}");
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn resume_top_level_tracked_resource_operation(&self, resource_group_name: &str, top_level_tracked_resource_name: &str, options: Option<ResourcesTopLevelClientResumeTopLevelTrackedResourceOperationOptions<'_>>) -> Result<Poller<TopLevelTrackedResource>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}");
