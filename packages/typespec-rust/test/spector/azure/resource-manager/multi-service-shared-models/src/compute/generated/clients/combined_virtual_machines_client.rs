...
impl CombinedVirtualMachinesClient {
    ...
    /// use spector_arm_multi_service_shared_models::compute::models::{CombinedVirtualMachinesClientCreateOrUpdateOperationStatus, CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders};
    ...
    #[tracing::function(
        "Azure.ResourceManager.MultiServiceSharedModels.Compute.VirtualMachines.createOrUpdate"
    )]
    pub fn create_or_update(
        ...
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachinesShared/{vmName}");
    ...
    /// * `options` - Optional parameters for the request.
    #[tracing::function(
        "Azure.ResourceManager.MultiServiceSharedModels.Compute.VirtualMachines.get"
    )]
    pub async fn get(
        &self,
        resource_group_name: &str,
