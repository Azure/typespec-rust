...
impl CombinedVirtualMachinesClient {
    ...
    /// use spector_arm_multi_service_shared_models::compute::models::{CombinedVirtualMachinesClientBeginCreateOrUpdateOperationStatus, CombinedVirtualMachinesClientBeginCreateOrUpdateOperationStatusHeaders};
    ...
    pub fn begin_create_or_update(
        ...
        struct CombinedVirtualMachinesClientBeginCreateOrUpdateMonitor {
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: CombinedVirtualMachinesClientBeginCreateOrUpdateMonitor =
                        json::from_json(&body)?;
