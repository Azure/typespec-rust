...
use crate::storage::generated::models::{
    CombinedStorageAccountsClientCreateOrUpdateOperationStatus,
    CombinedStorageAccountsClientCreateOrUpdateOptions, CombinedStorageAccountsClientGetOptions,
    StorageAccount,
};
use azure_core::{
...
#[tracing::client]
pub struct CombinedStorageAccountsClient {
...
impl CombinedStorageAccountsClient {
    ...
    /// * `account_name` - The name of the StorageAccount
    /// * `resource` - Resource create parameters.
    /// * `options` - Optional parameters for the request.
    ///
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`CombinedStorageAccountsClientCreateOrUpdateOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    /// use spector_arm_multi_service_shared_models::storage::models::{CombinedStorageAccountsClientCreateOrUpdateOperationStatus, CombinedStorageAccountsClientCreateOrUpdateOperationStatusHeaders};
    ...
    ///
    /// ### Available headers
    /// * [`azure_async_operation`()](crate::generated::models::CombinedStorageAccountsClientCreateOrUpdateOperationStatusHeaders::azure_async_operation) - azure-asyncoperation
    /// * [`retry_after`()](crate::generated::models::CombinedStorageAccountsClientCreateOrUpdateOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`CombinedStorageAccountsClientCreateOrUpdateOperationStatusHeaders`]: crate::generated::models::CombinedStorageAccountsClientCreateOrUpdateOperationStatusHeaders
    #[tracing::function(
        "Azure.ResourceManager.MultiServiceSharedModels.Storage.StorageAccounts.createOrUpdate"
    )]
    pub fn create_or_update(
        &self,
        resource_group_name: &str,
        account_name: &str,
        resource: RequestContent<StorageAccount>,
        options: Option<CombinedStorageAccountsClientCreateOrUpdateOptions<'_>>,
    ) -> Result<Poller<CombinedStorageAccountsClientCreateOrUpdateOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}");
        path = path.replace("{accountName}", account_name);
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: CombinedStorageAccountsClientCreateOrUpdateOperationStatus =
                        json::from_json(&body)?;
    ...
    /// * `options` - Optional parameters for the request.
    #[tracing::function(
        "Azure.ResourceManager.MultiServiceSharedModels.Storage.StorageAccounts.get"
    )]
    pub async fn get(
        &self,
        resource_group_name: &str,
        account_name: &str,
        options: Option<CombinedStorageAccountsClientGetOptions<'_>>,
    ) -> Result<Response<StorageAccount>> {
        if account_name.is_empty() {
            return Err(azure_core::Error::with_message(
                azure_core::error::ErrorKind::Other,
                "parameter account_name cannot be empty",
            ));
        }
