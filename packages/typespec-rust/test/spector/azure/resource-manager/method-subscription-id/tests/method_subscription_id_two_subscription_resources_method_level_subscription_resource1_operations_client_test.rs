...
use spector_armmethodsub::{
    ...
    two_subscription_resources_method_level::models::{
        SubscriptionResource1, SubscriptionResource1Properties,
    },
};
...
async fn subscription_resource1_get() {
    ...
    let resource: SubscriptionResource1 = resp.into_model().unwrap();
...
async fn subscription_resource1_put() {
    ...
    let created_resource: SubscriptionResource1 = resp.into_model().unwrap();
...
fn get_valid_subscription_resource1() -> SubscriptionResource1 {
    SubscriptionResource1 {
        id: Some(format!("/subscriptions/{SUBSCRIPTION_ID}/providers/Azure.ResourceManager.MethodSubscriptionId/subscriptionResource1s/{SUBSCRIPTION_RESOURCE1_NAME}")),
