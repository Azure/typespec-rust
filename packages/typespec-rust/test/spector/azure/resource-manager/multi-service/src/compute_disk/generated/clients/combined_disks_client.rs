...
impl CombinedDisksClient {
    ...
    /// use spector_arm_multi_service::compute_disk::models::{CombinedDisksClientCreateOrUpdateOperationStatus, CombinedDisksClientCreateOrUpdateOperationStatusHeaders};
    ...
    #[tracing::function("Azure.ResourceManager.MultiService.ComputeDisk.Disks.createOrUpdate")]
    pub fn create_or_update(
        ...
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/disks/{diskName}");
    ...
    /// * `disk_name` - The name of the Disk
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Azure.ResourceManager.MultiService.ComputeDisk.Disks.get")]
    pub async fn get(
        &self,
        resource_group_name: &str,
        disk_name: &str,
