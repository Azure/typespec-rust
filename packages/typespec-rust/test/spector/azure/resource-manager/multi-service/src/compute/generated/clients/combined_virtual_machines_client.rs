...
impl CombinedVirtualMachinesClient {
    ...
    /// use spector_arm_multi_service::compute::models::{CombinedVirtualMachinesClientCreateOrUpdateOperationStatus, CombinedVirtualMachinesClientCreateOrUpdateOperationStatusHeaders};
