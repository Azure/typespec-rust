...
use azure_core::{Error, Result, error::{ErrorKind, HttpError, }, http::{Context, Method, Pipeline, Request, Response, Url, }, tracing, };
use crate::generated::models::{ActionResult, ChangeAllowanceResult, OperationTemplatesOptionalBodyClientGetOptions, OperationTemplatesOptionalBodyClientPatchOptions, OperationTemplatesOptionalBodyClientPostOptions, OperationTemplatesOptionalBodyClientProviderPostOptions, Widget, };
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get(&self, resource_group_name: &str, widget_name: &str, options: Option<OperationTemplatesOptionalBodyClientGetOptions<'_>>) -> Result<Response<Widget>> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn patch(&self, resource_group_name: &str, widget_name: &str, options: Option<OperationTemplatesOptionalBodyClientPatchOptions<'_>>) -> Result<Response<Widget>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.OperationTemplates/widgets/{widgetName}");
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn post(&self, resource_group_name: &str, widget_name: &str, options: Option<OperationTemplatesOptionalBodyClientPostOptions<'_>>) -> Result<Response<ActionResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn provider_post(&self, options: Option<OperationTemplatesOptionalBodyClientProviderPostOptions<'_>>) -> Result<Response<ChangeAllowanceResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
