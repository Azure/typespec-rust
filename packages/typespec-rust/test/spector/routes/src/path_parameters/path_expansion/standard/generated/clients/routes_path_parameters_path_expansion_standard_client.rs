...
use crate::path_parameters::path_expansion::standard::generated::models::{
...
impl RoutesPathParametersPathExpansionStandardClient {
    ...
    #[tracing::function("Routes.PathParameters.PathExpansion.Standard.array")]
    pub async fn array(
        &self,
        param: &[&str],
    ...
    ///
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Routes.PathParameters.PathExpansion.Standard.primitive")]
