...
use crate::path_parameters::simple_expansion::standard::generated::models::{
    RoutesPathParametersSimpleExpansionStandardClientArrayOptions,
    RoutesPathParametersSimpleExpansionStandardClientPrimitiveOptions,
    RoutesPathParametersSimpleExpansionStandardClientRecordOptions,
};
use azure_core::{
...
impl RoutesPathParametersSimpleExpansionStandardClient {
    ...
    pub async fn array(
        &self,
        param: &[&str],
        options: Option<RoutesPathParametersSimpleExpansionStandardClientArrayOptions<'_>>,
    ...
    pub async fn primitive(
        &self,
        param: &str,
        options: Option<RoutesPathParametersSimpleExpansionStandardClientPrimitiveOptions<'_>>,
    ) -> Result<Response<(), NoFormat>> {
        if param.is_empty() {
