...
use crate::path_parameters::label_expansion::explode::generated::models::{
...
impl RoutesPathParametersLabelExpansionExplodeClient {
    ...
    #[tracing::function("Routes.PathParameters.LabelExpansion.Explode.array")]
    pub async fn array(
        &self,
        param: &[&str],
    ...
    ///
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Routes.PathParameters.LabelExpansion.Explode.primitive")]
