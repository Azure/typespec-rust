...
use crate::{
    generated::{clients::RoutesInInterfaceClient, models::RoutesClientFixedOptions},
    path_parameters::clients::RoutesPathParametersClient,
    query_parameters::clients::RoutesQueryParametersClient,
};
use azure_core::{
