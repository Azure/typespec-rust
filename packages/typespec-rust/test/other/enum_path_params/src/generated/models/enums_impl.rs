...
impl From<NumericValues> for i32 {
    fn from(value: NumericValues) -> Self {
        match value {
            NumericValues::OneTwo => 12,
            NumericValues::ThreeFour => 34,
        }
    }
}

impl Display for NumericValues {
    fn fmt(&self, f: &mut Formatter<'_>) -> ::std::fmt::Result {
        match self {
            NumericValues::OneTwo => Display::fmt(&12, f),
            NumericValues::ThreeFour => Display::fmt(&34, f),
        }
    }
}
