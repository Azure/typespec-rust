...
use crate::generated::clients::service_container_append_blob_client::ServiceContainerAppendBlobClient;
use crate::generated::clients::service_container_blob_client::ServiceContainerBlobClient;
use crate::generated::clients::service_container_block_blob_client::ServiceContainerBlockBlobClient;
use crate::generated::clients::service_container_page_blob_client::ServiceContainerPageBlobClient;
use crate::models::{
...
pub struct ServiceContainerClient {
...
/// Options used when creating a [`ServiceContainerClient`](crate::ServiceContainerClient)
#[derive(Clone, SafeDebug)]
pub struct ServiceContainerClientOptions {
    pub client_options: ClientOptions,
    pub version: String,
}

impl ServiceContainerClient {
    /// Creates a new ServiceContainerClient, using Entra ID authentication.
    ///
    /// # Arguments
    ///
    ...
    pub fn new(
        ...
        options: Option<ServiceContainerClientOptions>,
    ) -> Result<Self> {
    ...
    pub async fn acquire_lease(
        &self,
        options: Option<ServiceContainerClientAcquireLeaseOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientAcquireLeaseResult>> {
        let options = options.unwrap_or_default();
    ...
    pub async fn break_lease(
        &self,
        options: Option<ServiceContainerClientBreakLeaseOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientBreakLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn change_lease(
        ...
        options: Option<ServiceContainerClientChangeLeaseOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientChangeLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn create(
        &self,
        options: Option<ServiceContainerClientCreateOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientCreateResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn delete(
        &self,
        options: Option<ServiceContainerClientDeleteOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientDeleteResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn filter_blobs(
        &self,
        options: Option<ServiceContainerClientFilterBlobsOptions<'_>>,
    ...
    pub async fn get_access_policy(
        &self,
        options: Option<ServiceContainerClientGetAccessPolicyOptions<'_>>,
    ...
    pub async fn get_account_info(
        &self,
        options: Option<ServiceContainerClientGetAccountInfoOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientGetAccountInfoResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn get_properties(
        &self,
        options: Option<ServiceContainerClientGetPropertiesOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientGetPropertiesResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    /// Returns a new instance of ServiceContainerAppendBlobClient.
    ///
    /// # Arguments
    ///
    /// * `blob` - The name of the blob.
    pub fn get_service_container_append_blob_client(
        &self,
        blob: String,
    ) -> ServiceContainerAppendBlobClient {
        ServiceContainerAppendBlobClient {
            blob,
    ...
    /// Returns a new instance of ServiceContainerBlobClient.
    ///
    /// # Arguments
    ///
    /// * `blob` - The name of the blob.
    pub fn get_service_container_blob_client(&self, blob: String) -> ServiceContainerBlobClient {
        ServiceContainerBlobClient {
            blob,
            container_name: self.container_name.clone(),
            endpoint: self.endpoint.clone(),
            pipeline: self.pipeline.clone(),
    ...
    /// Returns a new instance of ServiceContainerBlockBlobClient.
    ///
    /// # Arguments
    ///
    /// * `blob` - The name of the blob.
    pub fn get_service_container_block_blob_client(
        &self,
        blob: String,
    ) -> ServiceContainerBlockBlobClient {
        ServiceContainerBlockBlobClient {
            blob,
            container_name: self.container_name.clone(),
            endpoint: self.endpoint.clone(),
    ...
    /// Returns a new instance of ServiceContainerPageBlobClient.
    ///
    /// # Arguments
    ///
    /// * `blob` - The name of the blob.
    pub fn get_service_container_page_blob_client(
        &self,
        blob: String,
    ) -> ServiceContainerPageBlobClient {
        ServiceContainerPageBlobClient {
            blob,
            container_name: self.container_name.clone(),
            endpoint: self.endpoint.clone(),
    ...
    pub async fn list_blob_flat_segment(
        &self,
        options: Option<ServiceContainerClientListBlobFlatSegmentOptions<'_>>,
    ...
    pub async fn list_blob_hierarchy_segment(
        &self,
        delimiter: &str,
        options: Option<ServiceContainerClientListBlobHierarchySegmentOptions<'_>>,
    ...
    pub async fn release_lease(
        &self,
        lease_id: &str,
        options: Option<ServiceContainerClientReleaseLeaseOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientReleaseLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn rename(
        ...
        options: Option<ServiceContainerClientRenameOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientRenameResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn renew_lease(
        &self,
        lease_id: &str,
        options: Option<ServiceContainerClientRenewLeaseOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientRenewLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn restore(
        &self,
        options: Option<ServiceContainerClientRestoreOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientRestoreResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn set_access_policy(
        ...
        options: Option<ServiceContainerClientSetAccessPolicyOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientSetAccessPolicyResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn set_metadata(
        &self,
        options: Option<ServiceContainerClientSetMetadataOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientSetMetadataResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
    ...
    pub async fn submit_batch(
        ...
        content_length: u64,
        options: Option<ServiceContainerClientSubmitBatchOptions<'_>>,
    ) -> Result<Response<ServiceContainerClientSubmitBatchResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/");
...
impl Default for ServiceContainerClientOptions {
    fn default() -> Self {
        Self {
