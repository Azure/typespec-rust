...
use azure_core::{base64::{deserialize_url_safe, serialize_url_safe, }, fmt::SafeDebug, time::OffsetDateTime, };
use serde::{Deserialize, Serialize, };
use std::collections::HashMap;
use super::{DeletionRecoveryLevel, JsonWebKeyCurveName, JsonWebKeyEncryptionAlgorithm, JsonWebKeyOperation, JsonWebKeySignatureAlgorithm, JsonWebKeyType, KeyEncryptionAlgorithm, KeyRotationPolicyAction, };
...
/// The backup blob containing the backed up key.
    #[serde(default, deserialize_with = "deserialize_url_safe", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// The time when the key was deleted, in UTC
    #[serde(default, rename = "deletedDate", skip_serializing_if = "Option::is_none", with = "azure_core::time::unix_time::option")]
...
/// The time when the key is scheduled to be purged, in UTC
    #[serde(default, rename = "scheduledPurgeDate", skip_serializing_if = "Option::is_none", with = "azure_core::time::unix_time::option")]
...
/// Elliptic curve name. For valid values, see JsonWebKeyCurveName.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub crv: Option<JsonWebKeyCurveName>,
...
/// Protected Key, used with 'Bring Your Own Key'.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "key_hsm", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
    pub t: Option<Vec<u8>>,
...
/// A base64url-encoded string containing certificates in PEM format, used for attestation validation.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "certificatePemFile", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// The attestation blob bytes encoded as base64url string corresponding to a private key.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "privateKeyAttestation", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// The attestation blob bytes encoded as base64url string corresponding to a public key in case of asymmetric key.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "publicKeyAttestation", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// Creation time in UTC.
    #[serde(default, skip_serializing_if = "Option::is_none", with = "azure_core::time::unix_time::option")]
...
/// Elliptic curve name. For valid values, see JsonWebKeyCurveName.
    ...
    pub curve: Option<JsonWebKeyCurveName>,
...
/// Additional data to authenticate but not encrypt/decrypt when using authenticated crypto algorithms.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "aad", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
    pub additional_authenticated_data: Option<Vec<u8>>,

/// The tag to authenticate when performing decryption with an authenticated algorithm.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "tag", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// The result of the operation.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "value", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// The encryption algorithm to use to protected the exported key material
    #[serde(skip_serializing_if = "Option::is_none")]
    pub enc: Option<KeyEncryptionAlgorithm>,
...
/// Blob encoding the policy rules under which the key can be released. Blob must be base64 URL encoded.
    #[serde(default, deserialize_with = "deserialize_url_safe", rename = "data", serialize_with = "serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// not configurable.
    ...
    pub lifetime_actions: Option<Vec<LifetimeActions>>,
...
/// The signing/verification algorithm identifier. For more information on possible algorithm types, see JsonWebKeySignatureAlgorithm.
    #[serde(rename = "alg", skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<JsonWebKeySignatureAlgorithm>,
