...
use crate::generated::models::{
    ...
    KeyRotationPolicy, KeySignParameters, KeyUpdateParameters, KeyVaultClientBackupKeyOptions,
    KeyVaultClientCreateKeyOptions, KeyVaultClientDecryptOptions, KeyVaultClientDeleteKeyOptions,
    KeyVaultClientEncryptOptions, KeyVaultClientGetDeletedKeyOptions,
    KeyVaultClientGetKeyAttestationOptions, KeyVaultClientGetKeyOptions,
    KeyVaultClientGetKeyRotationPolicyOptions, KeyVaultClientGetRandomBytesOptions,
    KeyVaultClientImportKeyOptions, KeyVaultClientListDeletedKeysOptions,
    KeyVaultClientListKeyVersionsOptions, KeyVaultClientListKeysOptions,
    KeyVaultClientPurgeDeletedKeyOptions, KeyVaultClientRecoverDeletedKeyOptions,
    KeyVaultClientReleaseOptions, KeyVaultClientRestoreKeyOptions, KeyVaultClientRotateKeyOptions,
    KeyVaultClientSignOptions, KeyVaultClientUnwrapKeyOptions, KeyVaultClientUpdateKeyOptions,
    KeyVaultClientUpdateKeyRotationPolicyOptions, KeyVaultClientVerifyOptions,
    KeyVaultClientWrapKeyOptions, KeyVerifyParameters, KeyVerifyResult, RandomBytes,
};
use azure_core::{
...
impl KeyVaultClient {
    ...
    pub async fn backup_key(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientBackupKeyOptions<'_>>,
    ...
    pub async fn create_key(
        ...
        options: Option<KeyVaultClientCreateKeyOptions<'_>>,
    ...
    pub async fn decrypt(
        ...
        options: Option<KeyVaultClientDecryptOptions<'_>>,
    ...
    pub async fn delete_key(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientDeleteKeyOptions<'_>>,
    ...
    pub async fn encrypt(
        ...
        key_version: &str,
        parameters: RequestContent<KeyOperationsParameters>,
        options: Option<KeyVaultClientEncryptOptions<'_>>,
    ) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get_deleted_key(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientGetDeletedKeyOptions<'_>>,
    ) -> Result<Response<DeletedKeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get_key(
        ...
        key_name: &str,
        key_version: &str,
        options: Option<KeyVaultClientGetKeyOptions<'_>>,
    ) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get_key_attestation(
        ...
        key_name: &str,
        key_version: &str,
        options: Option<KeyVaultClientGetKeyAttestationOptions<'_>>,
    ) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get_key_rotation_policy(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientGetKeyRotationPolicyOptions<'_>>,
    ...
    pub async fn get_random_bytes(
        ...
        options: Option<KeyVaultClientGetRandomBytesOptions<'_>>,
    ...
    pub async fn import_key(
        ...
        options: Option<KeyVaultClientImportKeyOptions<'_>>,
    ) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub fn list_deleted_keys(
        &self,
        options: Option<KeyVaultClientListDeletedKeysOptions<'_>>,
        ...
        Ok(Pager::from_callback(move |next_link: PagerState<Url>| {
            ...
            async move {
                ...
                let res: DeletedKeyListResult = json::from_json(&bytes)?;
    ...
    pub fn list_key_versions(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientListKeyVersionsOptions<'_>>,
    ...
    pub fn list_keys(
        &self,
        options: Option<KeyVaultClientListKeysOptions<'_>>,
    ) -> Result<Pager<KeyListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
    ...
    pub async fn purge_deleted_key(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientPurgeDeletedKeyOptions<'_>>,
    ...
    pub async fn recover_deleted_key(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientRecoverDeletedKeyOptions<'_>>,
    ) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn release(
        ...
        options: Option<KeyVaultClientReleaseOptions<'_>>,
    ...
    pub async fn restore_key(
        ...
        options: Option<KeyVaultClientRestoreKeyOptions<'_>>,
    ) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn rotate_key(
        &self,
        key_name: &str,
        options: Option<KeyVaultClientRotateKeyOptions<'_>>,
    ) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn sign(
        ...
        options: Option<KeyVaultClientSignOptions<'_>>,
    ) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn unwrap_key(
        ...
        key_version: &str,
        parameters: RequestContent<KeyOperationsParameters>,
        options: Option<KeyVaultClientUnwrapKeyOptions<'_>>,
    ) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn update_key(
        ...
        options: Option<KeyVaultClientUpdateKeyOptions<'_>>,
    ) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn update_key_rotation_policy(
        ...
        options: Option<KeyVaultClientUpdateKeyRotationPolicyOptions<'_>>,
    ) -> Result<Response<KeyRotationPolicy>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn verify(
        ...
        options: Option<KeyVaultClientVerifyOptions<'_>>,
    ...
    pub async fn wrap_key(
        ...
        key_version: &str,
        parameters: RequestContent<KeyOperationsParameters>,
        options: Option<KeyVaultClientWrapKeyOptions<'_>>,
    ) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
