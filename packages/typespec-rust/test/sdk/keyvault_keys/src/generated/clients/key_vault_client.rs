...
use azure_core::{Error, Result, credentials::TokenCredential, error::{ErrorKind, HttpError, }, fmt::SafeDebug, http::{ClientOptions, Context, Method, NoFormat, Pager, PagerResult, PagerState, Pipeline, RawResponse, Request, RequestContent, Response, Url, policies::{BearerTokenCredentialPolicy, Policy, }, }, json, tracing, };
use crate::generated::models::{BackupKeyResult, DeletedKeyBundle, DeletedKeyListResult, GetRandomBytesRequest, KeyBundle, KeyCreateParameters, KeyImportParameters, KeyListResult, KeyOperationResult, KeyOperationsParameters, KeyReleaseParameters, KeyReleaseResult, KeyRestoreParameters, KeyRotationPolicy, KeySignParameters, KeyUpdateParameters, KeyVaultClientBackupKeyOptions, KeyVaultClientCreateKeyOptions, KeyVaultClientDecryptOptions, KeyVaultClientDeleteKeyOptions, KeyVaultClientEncryptOptions, KeyVaultClientGetDeletedKeyOptions, KeyVaultClientGetKeyAttestationOptions, KeyVaultClientGetKeyOptions, KeyVaultClientGetKeyRotationPolicyOptions, KeyVaultClientGetRandomBytesOptions, KeyVaultClientImportKeyOptions, KeyVaultClientListDeletedKeysOptions, KeyVaultClientListKeyVersionsOptions, KeyVaultClientListKeysOptions, KeyVaultClientPurgeDeletedKeyOptions, KeyVaultClientRecoverDeletedKeyOptions, KeyVaultClientReleaseOptions, KeyVaultClientRestoreKeyOptions, KeyVaultClientRotateKeyOptions, KeyVaultClientSignOptions, KeyVaultClientUnwrapKeyOptions, KeyVaultClientUpdateKeyOptions, KeyVaultClientUpdateKeyRotationPolicyOptions, KeyVaultClientVerifyOptions, KeyVaultClientWrapKeyOptions, KeyVerifyParameters, KeyVerifyResult, RandomBytes, };
use std::sync::Arc;
...
/// * `options` - Optional configuration for the client.
    ...
    let options = options.unwrap_or_default();
        ...
        if !endpoint.scheme().starts_with("http") {
            return Err(azure_core::Error::message(azure_core::error::ErrorKind::Other, format!("{endpoint} must use http(s)")));
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get_key_attestation(&self, key_name: &str, key_version: &str, options: Option<KeyVaultClientGetKeyAttestationOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_deleted_keys(&self, options: Option<KeyVaultClientListDeletedKeysOptions<'_>>) -> Result<Pager<DeletedKeyListResult>> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_key_versions(&self, key_name: &str, options: Option<KeyVaultClientListKeyVersionsOptions<'_>>) -> Result<Pager<KeyListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_keys(&self, options: Option<KeyVaultClientListKeysOptions<'_>>) -> Result<Pager<KeyListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn purge_deleted_key(&self, key_name: &str, options: Option<KeyVaultClientPurgeDeletedKeyOptions<'_>>) -> Result<Response<(), NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("deletedkeys/{key-name}");
