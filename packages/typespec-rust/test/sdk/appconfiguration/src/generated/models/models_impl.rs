...
use super::{
    CreateSnapshotOperationStatus, Key, KeyListResult, KeyValue, KeyValueListResult, Label,
    LabelListResult, Snapshot, SnapshotListResult, SnapshotUpdateParameters,
};
...
impl StatusMonitor for CreateSnapshotOperationStatus {
