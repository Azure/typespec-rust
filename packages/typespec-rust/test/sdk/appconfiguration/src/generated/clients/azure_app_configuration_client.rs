...
use crate::generated::models::{
    ...
    AzureAppConfigurationClientPutLockOptions,
    AzureAppConfigurationClientResumeSnapshotOperationOptions,
    AzureAppConfigurationClientUpdateSnapshotOptions, CreateSnapshotRequestContentType,
...
impl AzureAppConfigurationClient {
    ...
    pub fn begin_create_snapshot(
        &self,
        content_type: CreateSnapshotRequestContentType,
        name: &str,
        entity: RequestContent<Snapshot>,
        accept: String,
        options: Option<AzureAppConfigurationClientBeginCreateSnapshotOptions<'_>>,
    ...
    /// * `name` - The name of the key-value snapshot to create.
    /// * `options` - Optional parameters for the request.
    #[tracing::function("AzureAppConfiguration.Snapshot.resume")]
    pub fn resume_snapshot_operation(
        &self,
        content_type: CreateSnapshotRequestContentType,
        name: &str,
        accept: String,
        options: Option<AzureAppConfigurationClientResumeSnapshotOperationOptions<'_>>,
    ) -> Result<Poller<Snapshot>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
